...
Command Block Studio 是面向 Minecraft `1.20.4`、`1.21.1`、`1.21.4` 与 `26.2` 的 NeoForge 原生命令方块编辑工作台。它把原版单行输入框替换为具有多行排版、Brigadier 补全、快速文档、语法诊断和工作区页签的编辑器。
...
| 项目 | 目标 |
| --- | --- |
| Minecraft | `1.20.4` / `1.21.1` / `1.21.4` / `26.2` |
| NeoForge | `20.4.167` / `21.1.217` / `21.4.121` / `26.2.0.10-beta` |
| Java | `21` |
