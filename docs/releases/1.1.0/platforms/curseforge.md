...
- Command block item tooltips can show a command excerpt and available edit metadata.
- A configurable work-mode key, defaulting to `Alt+Tab`, displays a command panel in front of the targeted command block.
