...
完整公共文档、版本选择、更新日志与发布资料统一由 `master` 维护，并发布到 [Command Block Studio 文档站](https://m1ofeather.github.io/CommandBlockStudio/)。本分支只维护 Minecraft 26.2 的代码与构建差异。
...
```text
build/libs/command_block_studio-1.1.0-26.2-NeoForge.jar
```
