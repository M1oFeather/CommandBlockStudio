...
<p align="center">
  <em>A NeoForge-native command block editor upgrade for Minecraft 1.21.4</em>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Minecraft-1.21.4-brightgreen?style=flat-square" alt="Minecraft 1.21.4">
  <img src="https://img.shields.io/badge/NeoForge-21.4.121%2B-blue?style=flat-square" alt="NeoForge 21.4.121 or newer">
...
**Command Block Studio** 是面向 Minecraft 1.21.4 NeoForge 的原生命令方块开发工作台。
...
完整公共文档、版本选择、更新日志与发布资料统一由 `master` 维护，并发布到 [Command Block Studio 文档站](https://m1ofeather.github.io/CommandBlockStudio/)。本分支只维护 Minecraft 1.21.4 的代码与构建差异。
...
| 依赖 | 说明 |
| --- | --- |
| **Minecraft 1.21.4** | 游戏本体 |
| **NeoForge 21.4.121 或更高** | 最低兼容加载器版本 |
| **Java 21** | 构建与运行环境 |
...
1. 要使用 Studio 界面时，将模组安装到 NeoForge 1.21.4 客户端；服务端是否安装不影响客户端连接。
...
```text
build/libs/command_block_studio-1.1.0-1.21.4-NeoForge.jar
```
...
<table>
  ...
  <tr>
    ...
    <td>Minecraft 1.21.4 · NeoForge 21.4.121+</td>
  </tr>
  <tr>
